  ...
  return (
    <BottomSheet
      ...
      <BottomSheetScrollView
        ...
        <Text style={styles.sectionTitle} allowFontScaling={false}>Filter</Text>
        <Text style={styles.subTitle} allowFontScaling={false}>Wine Type</Text>
        ...
        <View style={styles.divider} allowFontScaling={false} />
        <Text style={styles.subTitle} allowFontScaling={false}>Price Range</Text>
        <View>
          <FlatList
            data={priceRange}
            ...
            renderItem={({item, index}) => {
              ...
              return (
                <Pressable
                  ...
                  />
                  <Text style={styles.priceRangeText} allowFontScaling={false}>{item?.name}</Text>
                </Pressable>
              );
            }}
          />
        ...
        <View style={styles.divider}  allowFontScaling={false}/>
        <Text style={styles.subTitle} allowFontScaling={false}>Grapes</Text>
        <View style={styles.chipContainer}>
        ...
        <Text style={styles.subTitle} allowFontScaling={false}>Popular Country</Text>
        <View style={styles.chipContainer}>
